    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="max-w-md mx-auto px-4 text-center">
          ...
          <button
            onClick={() => { setSubmitted(false); setFormData({ name: '', email: '', phone: '', company: '', subject: 'general', message: '' }); }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-slate-600 text-sm mb-3">For general inquiries and quotes</p>
              <a href="mailto:info@ksapartcut.com" className="text-blue-600 hover:text-blue-700 font-medium">
                info@ksapartcut.com
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-slate-600 text-sm mb-3">Sun - Thu, 8AM - 6PM (AST)</p>
              <a href="tel:+966500000000" className="text-blue-600 hover:text-blue-700 font-medium">
                +966 50 000 0000
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <a href="https://wa.me/966500000000" className="text-blue-600 hover:text-blue-700 font-medium">
                Chat with us
              </a>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            {/* Map Placeholder */}
            <div className="mt-8 bg-slate-200 rounded-xl h-64 flex items-center justify-center">
